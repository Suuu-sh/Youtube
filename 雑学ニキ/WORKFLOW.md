...
- `body_health` は Shorts / Longform の両方で、真面目すぎる健康解説だけに寄せず、少し笑える・ニヤッとする人体ネタを混ぜる。
- `body_health` の「少しえっち」枠は、恋愛中の心拍・汗・匂い・キス・唾液・ホルモン・緊張反応など、出典で説明できる人体/健康雑学として扱う。
- 露骨な性描写、性的行為の手順、未成年の性的文脈、身体いじり、治療効果の断定は不可。画作りはいらすとやの安全な比喩・表情・ハート・汗などで軽く見せる。
- `body_health` の台本作成時は、Shorts / Longform ともに `prompts/body_health.md` を先に確認する。
