...
async function openShortsList(client) {
  await client.send('Page.navigate', {
    url: 'https://studio.youtube.com/channel/UCqw7FyE08T1ahE3mO2buk5w/videos/short',
  });
  await waitFor(
    client,
    'shorts list',
...
async function main() {
  ...
  try {
    ...
    await client.send('Page.navigate', {
      url: 'https://studio.youtube.com/channel/UCqw7FyE08T1ahE3mO2buk5w/videos/upload?d=ud',
    });
